...
public class WorldTest extends TestCase {
	...
	private int zoneSizeX = 50;
	private int zoneSizeY = 50;
	private double upInterval = 0.1;
	private double positionCheckInterval = 10;
	...
	protected void setUp() throws Exception {
		...
		this.world = new World(ts.getHosts(),ts.getWorldSizeX(), 
				ts.getWorldSizeY(), ts.getZoneSizeX(), ts.getZoneSizeY(), 
				ts.getPositionCheckInterval(),ts.getUpdateInterval(), 
	...
	private class TestScenario extends core.SimScenario {
		...
		public double getPositionCheckInterval() {
