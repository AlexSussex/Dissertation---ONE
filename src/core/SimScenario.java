...
public class SimScenario implements Serializable {
	...
	/** update interval for checking the positions of the hosts -setting id
	 * ({@value})*/
	...
	protected SimScenario() {
		...
		this.world = new World(hosts, worldSizeX, worldSizeY, zoneSizeX, zoneSizeY, positionCheckInterval, updateInterval, 
