...
public class GeoDTNHost extends DTNHost {
	...
	List <GeoDTNHost> hosts;
	List <Coord> hostCoords;
	double [][] data;
	...
	public GeoDTNHost(List<MessageListener> msgLs,
		...
		this.hostCoords = new ArrayList <Coord>();
	...
	public void connectionUp(Connection con) {
		...
		hosts.add((GeoDTNHost) con.toNode);
		//System.out.println(hosts.size());
		
		hostCoords.add(this.getLocation());
		
		System.out.println(hostCoords);
				
		
		//create a list of Connections to hold the new connections
		...
		//data = new double [][]{{this.getLocation().getX(), this.getLocation().getY()}};
