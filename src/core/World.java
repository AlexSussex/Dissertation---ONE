...
public class World {
	...
	private double positionCheckInterval;
	...
	public World(List<? extends DTNHost> hosts, int sizeX, int sizeY, //#changed list<DTNHost> to list<? extends DTNHost>
			int zoneSizeX, int zoneSizeY, double positionCheckInterval,
	...
	public void checkPosition() {
		int zones = (this.sizeX / zoneSizeX) * (this.sizeY / zoneSizeY);
		int zoneX;
		int zoneY;
