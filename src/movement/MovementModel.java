...
public abstract class MovementModel {
	...
	/** zone's size CSV (width, height) -setting id ({@value})*/
	public static final String ZONE_SIZE = "zoneSize";
	...
	public MovementModel(Settings settings) {
		...
		int [] zoneSize = settings.getCsvInts(ZONE_SIZE, 2);
	...
	public MovementModel(MovementModel mm) {
		...
		this.maxX = mm.maxX;
		this.maxY = mm.maxY;
		this.zoneSizeX = mm.zoneSizeX;
		this.zoneSizeY = mm.zoneSizeY;
		this.ah = mm.ah;
		this.comBus = null;
	}
	...
	public int getZoneSizeX(){
		return this.zoneSizeX;
	}
	
	public int getZoneSizeY(){
		return this.zoneSizeY;
	}
