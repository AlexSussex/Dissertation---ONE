...
/**
 * Implementation of Geocasting Spray And Flood Dynamic Ticketing Router (GSAFDT)
 */
public class GSAFDTRouter extends GeoActiveRouter {
	
	/** identifier for the initial number of copies setting ({@value})*/ 
	public static final String NROF_COPIES = "copyticket";
	/** SprayAndWait router's settings name space ({@value})*/ 
	public static final String GSAF_NS = "GSAFDTRouter";
	/** Message property key */
	public static final String MSG_COUNT_PROPERTY = "GSAFDTRouter" + "." +
		"copies";
	
	protected int initialNrofCopies;
	
	public GSAFDTRouter(Settings s) {
		super(s);
	 ...
	 */
	protected GSAFDTRouter(GSAFDTRouter r) {
		super(r);
	...
	@Override
	public GSAFDTRouter replicate() {
		return new GSAFDTRouter(this);
	}
}
